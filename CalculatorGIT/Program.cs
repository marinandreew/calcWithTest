...
namespace CalculatorGIT
{
    public class Program
    {
        ...
        public static int Pow(string[] vs)
        {
        ...
        public static int Div(string[] vs)
        {
            int Num1 = int.Parse(vs[0]);
            int Num2 = int.Parse(vs[1]);
            return Num1 / Num2;
        ...
        public static int Mult(string[] vs)
        {
            int Num1 = int.Parse(vs[0]);
            int Num2 = int.Parse(vs[1]);
            return Num1 * Num2;
        ...
        public static int Sub(string[] vs)
        {
            int Num1 = int.Parse(vs[0]);
            int Num2 = int.Parse(vs[1]);
            return Num1 - Num2;
        ...
        public static int Add(string[] vs)
        {
            int Num1 = int.Parse(vs[0]);
            int Num2 = int.Parse(vs[1]);
            return Num1 + Num2;
